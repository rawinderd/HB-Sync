...
class ProductCategoriesAdapter(private val itemClickListener: ProductCategories) :
    ...
    private var categoryList: MutableList<CategoriesForListing> = ArrayList()
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        var text = ItemsViewModel.categoryDetail.name
        when (holder) {
    ...
    fun setData(parentChildCategoriesMix: MutableList<CategoriesForListing>) {
    ...
    fun addCategorytoCategoryList(position: Int, categoriesForListing: CategoriesForListing) {
